...
# 基本思路-参见./posting_list_books.py

file_input_info = '../../../lab1_stage1/book_spider/doc/json/info_book.json'
file_input_words = '../doc/no_syn_words_books.json'  # 分词结果
file_input_book_list = '../../../lab1_stage1/book_spider/doc/book_id.txt'
file_output_book_list = '../doc/posting_list_books.json'
file_output_new_book_id = '../doc/new_books_id.txt'
